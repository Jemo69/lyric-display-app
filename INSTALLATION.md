...
Version: 6.3.15 | Windows 10/11 (64-bit)
...
**Windows:**
&nbsp;  [​Click here to download for Windows​](https://github.com/PeterAlaks/lyric-display-app/releases/download/v6.3.15/LyricDisplay-6.3.15-Windows-Setup.exe)

**MacOS:**
&nbsp;  [​Click here to download for Apple Silicon (M1/M2/M3, etc.)​](https://github.com/PeterAlaks/lyric-display-app/releases/download/v6.3.15/LyricDisplay-6.3.15-macOS-arm64.dmg)
&nbsp;  [​Click here to download for Intel Mac​](https://github.com/PeterAlaks/lyric-display-app/releases/download/v6.3.15/LyricDisplay-6.3.15-macOS-x64.dmg)

**Linux:**
&nbsp;  [​Click here to download for Linux​](https://github.com/PeterAlaks/lyric-display-app/releases/download/v6.3.15/LyricDisplay-6.3.15-Linux.AppImage)
