...
Version: 6.5.1 | Windows 10/11 (64-bit)
...
**Windows:**
&nbsp;  [​Click here to download for Windows​](https://github.com/Jemo69/lyric-display-app/releases/download/v6.5.1/LyricDisplay-6.5.1-Windows-Setup.exe)

**MacOS:**
&nbsp;  [​Click here to download for Apple Silicon (M1/M2/M3, etc.)​](https://github.com/Jemo69/lyric-display-app/releases/download/v6.5.1/LyricDisplay-6.5.1-macOS-arm64.dmg)
&nbsp;  [​Click here to download for Intel Mac​](https://github.com/Jemo69/lyric-display-app/releases/download/v6.5.1/LyricDisplay-6.5.1-macOS-x64.dmg)

**Linux:**
&nbsp;  [​Click here to download for Linux​](https://github.com/Jemo69/lyric-display-app/releases/download/v6.5.1/LyricDisplay-6.5.1-Linux.AppImage)
