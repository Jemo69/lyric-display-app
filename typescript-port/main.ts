...
const hasLock = setupSingleInstanceLock((commandLine: string[]) => {
...
app.whenReady().then(async () => {
  ...
  mainWindow = await performStartupSequence({
    menuAPI,
    requestRendererModal,
    handleDisplayChange: (changeType: string, display: Electron.Display) =>
